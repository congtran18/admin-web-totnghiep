...
const OrderRestoreBook = () => {
    ...
    const queryParams = { ...queryString.parse(location.search), limit, track: true, type: "book"  };
            ...
            <Grid container spacing={2}>
                <Grid item md={22} xs={12}>
                    ...
                    <Card sx={{ p: 0.5 }}>
                        ...
                        >
                            <h4 sx={{ fontSize: "medium" }}>Quản lý hóa đơn sách</h4>
                        </Box>
                        ...
                        >
                            <Box sx={{ display: 'flex' }}>
                                ...
                                />
                                <Button variant="contained" color="success" sx={{ width: '24vh', textAlign: 'center', fontSize: '14px' }} to={'/orderbook/manage'} as={Link}>
                                    Quản lí
                                    <IconButton>
                                        bookmark
                                    </IconButton>
...
export default OrderRestoreBook
